...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.slider_light_perception.setObjectName("slider_light_perception")
        self.verticalLayout_4.addWidget(self.slider_light_perception)
        ...
        self.verticalLayout_5.addWidget(self.slider_brightness)
        ...
        self.verticalLayout_14.addWidget(self.slider_exposure)
        ...
        self.verticalLayout_13.addWidget(self.slider_contrast)
        ...
        self.verticalLayout_9.addWidget(self.slider_temperature)
        self.verticalLayout_15.addWidget(self.widget_temperature)
        self.widget_hue = QtWidgets.QWidget(self.scrollAreaWidgetContents)
        self.widget_hue.setMinimumSize(QtCore.QSize(0, 88))
        self.widget_hue.setMaximumSize(QtCore.QSize(16777215, 88))
        self.widget_hue.setObjectName("widget_hue")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.widget_hue)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.horizontalLayout_hue = QtWidgets.QHBoxLayout()
        ...
        self.label_text_hue = QtWidgets.QLabel(self.widget_hue)
        self.label_text_hue.setMinimumSize(QtCore.QSize(90, 30))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.horizontalLayout_hue.setStretch(1, 4)
